...
$mail->Password = 'E8861e2c210'; // Ваш пароль от почты с которой будут отправляться письма
...
$mail->Body    = '' .$nameUser. ' <br> '.$phone. '<br>' .$nameCompany. '<br>' .$description. '<br>' .$phone. '<br>' .$email. '';
$mail->AltBody = '';
