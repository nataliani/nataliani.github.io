...
<div id="prev_menu">
    ...
    <div id="work" class="anchor">
        ...
        <ul id="listWork">
            <li><h2>2016 – по настоящее время</h2> Инженер удостоверяющего центра.
                ...
                <h3>Обязанности:</h3>
                <ul>
                    <li>Подготовка комплекта документов для выпуск электронной подписи;</li>
                    <li>выставление счетов на оплату покупателям в программе 1С;</li>
                    <li>контроль оплаты счетов;</li>
                    <li>работа с кассовыми аппратами;</li>
                    <li>ведение кассовой документации;</li>
                    <li>проведение закупок защищенных носителей и проведение их в программе 1С;</li>
                    ...
                    <li>контроль выручки и выполнения плана подразделения;</li>
                    <li>подбор и обучение новых сотрудников.</li>
                </ul>
                <h3>Результаты</h3>
                <ul>
                    ...
                    <li>получены навыки работы в программе 1С;</li>
                </ul>
            </li>
            <li>
    ...
    <div id="achievements" class="anchor">     
        ...
        <ul>
            <li>освоила основы вёрстки (html5 и css3)</li>
            <li>изучаю javaScript и библиотеку jQuery, знаю основы и умею работать с DOM;</li>
            <li>изучила основы использования git;</li>
            <li>финалист программы <em>«УМНИК 2015»</em>;</li>
            <li>участница спортивного фестиваля студентов Азии <em>«Новое поколение 2015»;</em>;</li>
            <li>ответственная, легко обучаемая, коммуникабельная, обладаю организаторскими способностями. Готова изучать новые продукты и языки программирования. Без вредных привычек.</li>
        </ul>
