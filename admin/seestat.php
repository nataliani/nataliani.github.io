...
<tr>
<th class="zz" width="100"><b>Время и дата</b></th>
<th class="zz" width="200"><b>Данные о посетителе</b></th>
<th class="zz" width="100"><b>IP/прокси</b></th>
<th class="zz" width="280"><b>Посещенный URL</b></th>
</tr>

<?php
for ($si=sizeof($file)-1; $si+1>sizeof($file)-$col; $si--) {
    $string=explode("|",$file[$si]);
    $ql[$si]=$string[0];// дата и время
...
echo '</table>';
echo '<br>Просмотреть последние <a href=?col=100>100</a> ';
echo '<a href=?col=500>500</a> ';
